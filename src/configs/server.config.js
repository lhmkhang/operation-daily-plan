...
const serverConfiguration = (app, redisStore) => {
  ...
  app.use(
    session({
      ...
      cookie: { secure: false, maxAge: Number(process.env.SESSION_LIFE_TIME), httpOnly: true },
      genid: function (req) {
  ...
  app.use(
    "/public",
    express.static("C:/Users/lhmkhang/Documents/Nodejs/operation-daily-plan/back-end/src/public")
  );
